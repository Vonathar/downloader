...
import static io.github.vonathar.downloader.testutils.ReflectionUtils.getField;
...
class DownloaderBuilderTest {
  ...
  @Test
  public void
  build_DownloadPathRenamed_ShouldCreateDownloaderWithCorrectDownloadPath() {
    ...
    Path expected =
        Path.of("src/test/resources/directory_creator/existing_2");

...
class SetPartitionerTest {
  ...
  @Test
  void partition_ShouldSuccessfullyPartitionForAnyNumberOfPartitions() {
    HashSet<String> set = new HashSet<>(List.of("1", "2", "3", "4", "5", "6", "7", "8"));

    List<Set<String>> output = partitioner.partition(set, 2);
    HashSet<String> set1 = new HashSet<>(List.of("1", "3", "5", "7"));
    HashSet<String> set2 = new HashSet<>(List.of("2", "4", "6", "8"));
  ...
  void partition_ShouldSuccessfullyPartitionMultiElementSets() {
    HashSet<String> set = new HashSet<>(List.of("1", "2", "3", "4", "5", "6", "7", "8", "9"));
  ...
  @Test
  void partition_ShouldSuccessfullyPartitionSetsWithUnevenElements() {
    HashSet<String> set = new HashSet<>(List.of("1", "2", "3", "4", "5"));
